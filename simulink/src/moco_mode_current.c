...
#define S_FUNCTION_NAME  moco_mode_current
#define S_FUNCTION_LEVEL 2
#define NPARAMS          0

#define IN_PORT_0_NAME moco_ctx
#define IN_PORT_1_NAME max_current
#define IN_PORT_2_NAME pi_d.ki
#define IN_PORT_3_NAME pi_d.ki_sat
#define IN_PORT_4_NAME pi_d.kp
#define IN_PORT_5_NAME pi_q.ki
#define IN_PORT_6_NAME pi_q.ki_sat
#define IN_PORT_7_NAME pi_q.kp

#include "simstruc.h"
#include "moco_mode_current.h"
...
//see: https://www.mathworks.com/help/simulink/ug/control-linked-block-status-programmatically.html
    ...
    if (dim_array[1] < 5) { //not linked
        ...
        normInputs[2] = mxCreateString("port_label('input', 1, 'moco_ctx');port_label('input', 2, 'max_current');port_label('input', 3, 'pi_d.ki');port_label('input', 4, 'pi_d.ki_sat');port_label('input', 5, 'pi_d.kp');port_label('input', 6, 'pi_q.ki');port_label('input', 7, 'pi_q.ki_sat');port_label('input', 8, 'pi_q.kp');disp('moco_mode_current')");
        mexCallMATLAB(0, 0, 3, normInputs, "set_param");
