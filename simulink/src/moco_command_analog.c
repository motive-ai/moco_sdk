...
#define S_FUNCTION_NAME  moco_command_analog
#define S_FUNCTION_LEVEL 2
#define NPARAMS          0

#define IN_PORT_0_NAME moco_ctx
#define IN_PORT_1_NAME analog_desired
#define IN_PORT_2_NAME motor_torque_feed_forward

#include "simstruc.h"
#include "moco_command_analog.h"
...
//see: https://www.mathworks.com/help/simulink/ug/control-linked-block-status-programmatically.html
    ...
    if (dim_array[1] < 5) { //not linked
        ...
        normInputs[2] = mxCreateString("port_label('input', 1, 'moco_ctx');port_label('input', 2, 'analog_desired');port_label('input', 3, 'motor_torque_feed_forward');disp('moco_command_analog')");
        mexCallMATLAB(0, 0, 3, normInputs, "set_param");
