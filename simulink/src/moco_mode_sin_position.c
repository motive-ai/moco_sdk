...
#define S_FUNCTION_NAME  moco_mode_sin_position
#define S_FUNCTION_LEVEL 2
#define NPARAMS          0

#define IN_PORT_0_NAME moco_ctx
#define IN_PORT_1_NAME position_param.kd
#define IN_PORT_2_NAME position_param.ki
#define IN_PORT_3_NAME position_param.ki_sat
#define IN_PORT_4_NAME position_param.kp
#define IN_PORT_5_NAME position_param.position_filter_hz
#define IN_PORT_6_NAME position_param.velocity_limit
#define IN_PORT_7_NAME position_param.velocity_param.kd
#define IN_PORT_8_NAME position_param.velocity_param.ki
#define IN_PORT_9_NAME position_param.velocity_param.ki_sat
#define IN_PORT_10_NAME position_param.velocity_param.kp
#define IN_PORT_11_NAME position_param.velocity_param.motor_torque_param.current_param.max_current
#define IN_PORT_12_NAME position_param.velocity_param.motor_torque_param.current_param.pi_d.ki
#define IN_PORT_13_NAME position_param.velocity_param.motor_torque_param.current_param.pi_d.ki_sat
#define IN_PORT_14_NAME position_param.velocity_param.motor_torque_param.current_param.pi_d.kp
#define IN_PORT_15_NAME position_param.velocity_param.motor_torque_param.current_param.pi_q.ki
#define IN_PORT_16_NAME position_param.velocity_param.motor_torque_param.current_param.pi_q.ki_sat
#define IN_PORT_17_NAME position_param.velocity_param.motor_torque_param.current_param.pi_q.kp
#define IN_PORT_18_NAME position_param.velocity_param.motor_torque_param.kt
#define IN_PORT_19_NAME position_param.velocity_param.velocity_filter_hz
#define IN_PORT_20_NAME trajectory_mode

#include "simstruc.h"
#include "moco_mode_sin_position.h"

static void mdlInitializeSizes(SimStruct *S) {
    int_T nInputPorts  = 21;  // number of input ports
...
//see: https://www.mathworks.com/help/simulink/ug/control-linked-block-status-programmatically.html
    ...
    if (dim_array[1] < 5) { //not linked
        ...
        normInputs[2] = mxCreateString("port_label('input', 1, 'moco_ctx');port_label('input', 2, 'position_param.kd');port_label('input', 3, 'position_param.ki');port_label('input', 4, 'position_param.ki_sat');port_label('input', 5, 'position_param.kp');port_label('input', 6, 'position_param.position_filter_hz');port_label('input', 7, 'position_param.velocity_limit');port_label('input', 8, 'position_param.velocity_param.kd');port_label('input', 9, 'position_param.velocity_param.ki');port_label('input', 10, 'position_param.velocity_param.ki_sat');port_label('input', 11, 'position_param.velocity_param.kp');port_label('input', 12, 'position_param.velocity_param.motor_torque_param.current_param.max_current');port_label('input', 13, 'position_param.velocity_param.motor_torque_param.current_param.pi_d.ki');port_label('input', 14, 'position_param.velocity_param.motor_torque_param.current_param.pi_d.ki_sat');port_label('input', 15, 'position_param.velocity_param.motor_torque_param.current_param.pi_d.kp');port_label('input', 16, 'position_param.velocity_param.motor_torque_param.current_param.pi_q.ki');port_label('input', 17, 'position_param.velocity_param.motor_torque_param.current_param.pi_q.ki_sat');port_label('input', 18, 'position_param.velocity_param.motor_torque_param.current_param.pi_q.kp');port_label('input', 19, 'position_param.velocity_param.motor_torque_param.kt');port_label('input', 20, 'position_param.velocity_param.velocity_filter_hz');port_label('input', 21, 'trajectory_mode');disp('moco_mode_sin_position')");
        mexCallMATLAB(0, 0, 3, normInputs, "set_param");
...
static void mdlOutputs(SimStruct *S, int_T tid) {
    moco_mode_sin_position_outputs(S);
}
