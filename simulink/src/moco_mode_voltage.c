...
#define S_FUNCTION_NAME  moco_mode_voltage
#define S_FUNCTION_LEVEL 2
#define NPARAMS          0

#define IN_PORT_0_NAME moco_ctx
#define IN_PORT_1_NAME reserved

#include "simstruc.h"
#include "moco_mode_voltage.h"
...
//see: https://www.mathworks.com/help/simulink/ug/control-linked-block-status-programmatically.html
    ...
    if (dim_array[1] < 5) { //not linked
        ...
        normInputs[2] = mxCreateString("port_label('input', 1, 'moco_ctx');port_label('input', 2, 'reserved');disp('moco_mode_voltage')");
        mexCallMATLAB(0, 0, 3, normInputs, "set_param");
