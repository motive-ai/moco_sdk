...
#define S_FUNCTION_NAME  moco_init
#define S_FUNCTION_LEVEL 2
#define NPARAMS          1

#define OUT_PORT_0_NAME moco_ctx
#define IN_PORT_0_NAME send_port
#define IN_PORT_1_NAME receive_port
...
//see: https://www.mathworks.com/help/simulink/ug/control-linked-block-status-programmatically.html
    ...
    if (dim_array[1] < 5) { //not linked
        ...
        normInputs[2] = mxCreateString("port_label('output', 1, 'moco_ctx');port_label('input', 1, 'send_port');port_label('input', 2, 'receive_port');disp('moco_init')");
        mexCallMATLAB(0, 0, 3, normInputs, "set_param");
